...
gesLive = !(
  ...
  !window.location.host.replace(/localhost|127\.0\.0\.1|kitsarinnn\.github\.io/i, "") ||
  "localhost" === location.hostname || // ถ้าจะเอาขึ้นเซิฟต้องเพิ่ม host ในนี้ด้วย 
  "127.0.0.1" === location.hostname ||
  "kitsarinnn.github.io" === location.hostname ||
  "Upsdigital.github.io" === location.hostname
);
var failed = !1;
